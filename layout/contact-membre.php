...
$destinataireMembre = $email_membre;
...
if (isset($_POST['envoi']))
{
	if (($contactNom != '') && ($contactEmail != '') && ($objet != '') && ($contactMessage != ''))
	{
		...
		$headers .= 'From:'.$contactNom.' <'.$contactEmail.'>' . "\r\n" .
		...
		if ($copie == 'oui')
		{
			$cible = $destinataireMembre.';'.$contactEmail;
		}
		else
		{
			$cible = $destinataireMembre;
		};
...
if (($err_formulaire) || (!isset($_POST['envoi'])))
{
	...
	echo '
	<form id="contact-membre" method="post">
		<fieldset>
